...
console.log('Admin Lessons');

const DATATABLE_ID = '#lessons-table';
const DATA_GET_URL = '/lessons';
const DATA_DELETE_URL = '/lesson/';

const $table = $(DATATABLE_ID);
...
function initTable() {
    // get all instruments
    axios.get(DATA_GET_URL).then(res => {
    ...
    $table.on('click', '.delete', function (e) {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                axios.delete(DATA_DELETE_URL + id).then(res => {
                    console.log(res);
                    Swal.fire({
                        title: 'Deleted!',
